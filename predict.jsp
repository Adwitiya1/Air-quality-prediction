...
<%@page import="com.air.dblogic.UserDao"%>
<%@page import="com.air.dao.UserDAO"%>
                        ...
                        <div class="main_slider_area">
                            <div class="slider">
                                <div class="single_slider wow fadeIn" data-wow-duration="2s">
                                    ...
                                    <h3><%= msg%></h3>
                                    <br /><br />
                                    <form action="./PredictAirQuality" method ="post" onsubmit="return ShowLoading()">
                                                ...
                                                <td>
                                                    <select name="location">
                                                        ...
                                                        <%
                                                            ...
                                                            ResultSet rs = dao.getAllLocation();

                                                            while (rs.next()) {
                                                        %>
                                                        <option value="<%=rs.getString("loc")%>"><%=rs.getString("loc")%></option>
                                                        <%
                                                            }
                                                        %>
                                                    </select>
