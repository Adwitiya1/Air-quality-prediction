                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="collapse navbar-collapse"
                                        ...
                                        <ul class="nav navbar-nav navbar-right">
                                            ...
                                            <li><a href="prepare.jsp" class="btn btn-white">Prepare Data</a></li>
                                            <li><a href="add_location.jsp" class="btn btn-white">Add Location</a></li>
                                            <li><a href="upload_data.jsp" class="btn btn-white">Upload Dataset</a></li>
